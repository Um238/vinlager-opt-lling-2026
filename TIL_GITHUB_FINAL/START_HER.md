...
- Åbn `index.html` i din browser (i root eller frontend mappen)

**Option B: Med Live Server (anbefalet)**
- I VS Code: Højreklik på `index.html` → "Open with Live Server"
...
- Check `config.js` (root) eller `frontend/config.js` - er API_URL korrekt?
